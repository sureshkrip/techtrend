...
- [ ] 02-02-PLAN.md — `anthropic` dependency gate (blocking human legitimacy checkpoint) + LLM client, structured `EnrichmentResult`, grounded/anti-injection prompt
...
| 2. Cost-Gated LLM Enrichment | 2/5 | In Progress|  |
