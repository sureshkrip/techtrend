...
- [x] **ENR-01**: Only items clearing a configurable ranking threshold are sent to the LLM for enrichment
...
- [x] **ENR-06**: Enrichment failures do not lose ingested data; the item remains ranked and displayed without a summary
